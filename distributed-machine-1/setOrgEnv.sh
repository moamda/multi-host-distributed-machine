...
ORDERER_CA=${DIR}/distributed-machine-1/organizations/ordererOrganizations/example.com/tlsca/tlsca.example.com-cert.pem
PEER0_ORG1_CA=${DIR}/distributed-machine-1/organizations/peerOrganizations/org1.example.com/tlsca/tlsca.org1.example.com-cert.pem
PEER0_ORG2_CA=${DIR}/distributed-machine-1/organizations/peerOrganizations/org2.example.com/tlsca/tlsca.org2.example.com-cert.pem
PEER0_ORG3_CA=${DIR}/distributed-machine-1/organizations/peerOrganizations/org3.example.com/tlsca/tlsca.org3.example.com-cert.pem
...
if [[ ${ORG,,} == "org1" || ${ORG,,} == "digibank" ]]; then
   ...
   CORE_PEER_ADDRESS=192.168.1.101:7051
   ...
   CORE_PEER_ADDRESS=192.168.1.101:9051
