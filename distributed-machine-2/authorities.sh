...
export FABRIC_CA_SERVER_ADDRESS=192.168.1.102
export FABRIC_CA_SERVER_PORT=8054
export FABRIC_CA_SERVER_OPERATIONS_LISTENADDRESS=192.168.1.102:18054
export FABRIC_CA_SERVER_CSR_HOSTS="localhost,192.168.1.102"
...
set -x
fabric-ca-client enroll -u https://admin:adminpw@192.168.1.102:8054 --caname ca-org2 --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
{ set +x; } 2>/dev/null

echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/192-168-1-102-8054-ca-org2.pem
...
set -x
fabric-ca-client enroll -u https://peer0:peer0pw@192.168.1.102:8054 --caname ca-org2 -M "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://peer0:peer0pw@192.168.1.102:8054 --caname ca-org2 -M "${PWD}/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org2.example.com --csr.hosts 192.168.1.102 --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://user1:user1pw@192.168.1.102:8054 --caname ca-org2 -M "${PWD}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://org2admin:org2adminpw@192.168.1.102:8054 --caname ca-org2 -M "${PWD}/organizations/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
{ set +x; } 2>/dev/null
